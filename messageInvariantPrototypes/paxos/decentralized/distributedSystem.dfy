...
module DistributedSystem {
  ...
  ghost predicate NextStep(c: Constants, v: Variables, v': Variables, n: Network.Variables, n': Network.Variables, step: Step)
  ...
  ghost predicate Next(c: Constants, v: Variables, v': Variables)
  {
    && v.WF(c)
    && v'.WF(c)
    && exists step :: NextStep(c, v, v', v.network, v'.network, step)
  }
