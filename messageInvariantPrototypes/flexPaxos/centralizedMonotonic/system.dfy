...
ghost predicate Init(c: Constants, v: Variables) {
  && v.WF(c)
  && |v.history| == 1
  && LeaderHost.GroupInit(c.leaderConstants, v.history[0].leaders, c.p1Quorum)
  && AcceptorHost.GroupInit(c.acceptorConstants, v.history[0].acceptors, c.n)
  && LearnerHost.GroupInit(c.learnerConstants, v.history[0].learners, c.p2Quorum)
}
